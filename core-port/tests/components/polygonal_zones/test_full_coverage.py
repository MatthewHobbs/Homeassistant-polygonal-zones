...
from homeassistant.components.polygonal_zones.config_flow import (
    ConfigFlow,
    OptionsFlowHandler,
)
...
from homeassistant.components.polygonal_zones.services.helpers import parse_zone_feature
from homeassistant.components.polygonal_zones.utils.general import (
...
async def test_load_data_streamed_body_exceeds_max(tmp_path) -> None:
    ...
    with (
        patch(
            "homeassistant.components.polygonal_zones.utils.general.aiohttp.TCPConnector",
            return_value=MagicMock(),
        ),
        patch(
            "homeassistant.components.polygonal_zones.utils.general.aiohttp.ClientSession",
