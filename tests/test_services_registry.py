...
async def test_register_services_loads_each_module_and_registers() -> None:
    ...
    hass = SimpleNamespace(
        services=SimpleNamespace(
            async_register=register_mock,
            async_register_admin_service=admin_register_mock,
        ),
...
async def test_register_services_admin_uses_admin_register() -> None:
    ...
    registered_names = {call.args[1] for call in admin_register_mock.call_args_list}
